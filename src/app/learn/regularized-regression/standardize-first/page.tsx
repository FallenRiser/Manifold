  ...
  return (
    <article>
      ...
      <div className="lesson">
        ...
        <Callout color="var(--c-regression)" title={<>Two details that trip people up</>}>
        ...
        <PrevNext prev={{ href: "/learn/regularized-regression/tuning-the-mix", label: <>← Tuning the mix</> }} next={{ href: "/learn/regularized-regression/cross-validating-the-penalty", label: <>Next up · Cross-validating the penalty →</> }} />
      </div>
    </article>
  );
}
